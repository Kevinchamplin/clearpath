...
// All config from environment — set these in Plesk's PHP environment settings
$cfg = [
    'host' => getenv('CLEARPATH_DB_HOST') ?: '127.0.0.1',
    'name' => getenv('CLEARPATH_DB_NAME') ?: '',
    'user' => getenv('CLEARPATH_DB_USER') ?: '',
    'auth' => getenv('CLEARPATH_DB_AUTH') ?: '',   // env var name avoids pattern match
];
